                            ...
                            <div className="flex flex-col gap-2 w-full">
                                ...
                                <span className=" flex flex-wrap gap-2">
                                    {photoData.tags.map((tag:any) => (
                                        <a key={tag.title} className="border border-darkMode-colors-primary rounded-sm px-4 py-2 hover:bg-gray-300 dark:hover:bg-gray-700 duration-200">{tag.title}</a>
                                    ))}
                                </span>
                            </div>                          
                        </div>
